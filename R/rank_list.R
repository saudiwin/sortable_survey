...
#' Ranking question for use in surveydown
#'
#' @description This question is a clone of [rank_list] but with
#' some modifications to allow it to be used with in the [surveydown]
#' R package. For more information about function options,
#' see [rank_list] documentation.
#'
#'
#'
#' @param input_id output variable to read the plot/image from.
...
#' @param orientation Set this to "horizontal" to get horizontal orientation of
#'   the items.
#' @param output_width Width of the html widget. Need to set for
#' compatibility with Quarto and surveydown.
#'
#' @param output_height Height of the html widget. Need to set for
#' compatibility with Quarto and surveydown.
#'
#' @template options
#'
